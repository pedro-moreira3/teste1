...
public class MarkersView implements Serializable {
    ...
    public void addMapModel1() {
        ...
        Marker marker1 = new Marker(coord1, "Canal Street", null, "resources/ultima-layout/images/marker-icon-red.png");
        Marker marker2 = new Marker(coord2, "Fulton Street", null, "resources/ultima-layout/images/marker-icon-blue.png");
        Marker marker3 = new Marker(coord3, "Barclay Street", null, "resources/ultima-layout/images/marker-icon-green.png");
        Marker marker4 = new Marker(coord4, "Beaver Street", null, "resources/ultima-layout/images/marker-icon-blue.png");
    ...
    public void addMapModel3() {
        ...
        Marker marker1 = new Marker(coord1, "Canal Street", null, "resources/ultima-layout/images/marker-icon-red.svg");
