    ...
    public String encodeWebsocketURL(String url) {
       ...
       // System.out.println("teste: " + encodeWebsocketURL);
        if(encodeWebsocketURL.contains("ltdeapp07")) {        
            return encodeWebsocketURL.replace("ltdeapp07:8080", "dev-intelidente.lumetec.com.br:8080");
           ...
           // System.out.println("b: " + encodeWebsocketURL);            
            return encodeWebsocketURL.replaceFirst("ws://", "wss://").replace("azprintelidenteapp:8080", "sistema.intelidente.com:8080");
