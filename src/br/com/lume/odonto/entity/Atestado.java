...
public class Atestado implements Serializable {
    ...
    @Lob()
    @Column(name = "ATESTADO_GERADO")
    private String atestadoGerado;
    ...
    public String getAtestadoGerado() {
        return this.atestadoGerado;
    }

    public void setAtestadoGerado(String atestadoGerado) {
        this.atestadoGerado = atestadoGerado;
    }
