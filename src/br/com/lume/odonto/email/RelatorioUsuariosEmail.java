    ...
    public void doRelatorioGerencialEmail() {
        try {
            ...
            if (cal.get(Calendar.DAY_OF_WEEK) == Calendar.MONDAY) {
                String emails = "joao.serra@lumetec.com.br;ariel.pires@lumetec.com.br;ricardo.poncio@lumetec.com.br;rogerio.nagata@lumetec.com.br;alvaro@consultoriolegal.com.br";
                ...
                EnviaEmail.enviaEmailOffLine("no-reply@intelidente.com", emails, "Intelidente - Resumo semanal de usuários ", RelatorioGerencialSingleton.getInstance().getBo().gerarRelatorioUsuario(),
                        Mensagens.getMensagemOffLine("email.smtpHost.homolog"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
