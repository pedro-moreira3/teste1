...
import br.com.lume.odonto.bo.ReciboBO;
...
@ManagedBean
@ViewScoped
public class ReciboMB extends LumeManagedBean<Recibo> {
    ...
    private Logger log = Logger.getLogger(ReciboMB.class);
    ...
    public ReciboMB() {
        ...
        reciboBO = new ReciboBO();
        pacienteBO = new PacienteBO();
        try {
            Dominio dominio = dominioBO.findByEmpresaAndObjetoAndTipoAndValor("documento", "tipo", "RC");
    ...
    public void actionPersist(ActionEvent event) {
        try {
            ...
            reciboBO.persist(this.getEntity());
    ...
    public void actionNew(ActionEvent event) {
        ...
        paciente = null;
        this.setEntity(new Recibo());
    }

    @Override
    public List<Recibo> getEntityList() {
        // return super.getEntityList();
        if (paciente != null) {
            try {
                return reciboBO.listByPaciente(paciente);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
