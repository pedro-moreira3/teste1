...
//        }
    ...
    public void filtra() {
        ...
        if (UtilsFrontEnd.getProfissionalLogado() != null) {
            this.estoques = EstoqueSingleton.getInstance().getBo().listAllByFilterToReportGroupByItemFiltrado(filtroItem, filtroTipo, UtilsFrontEnd.getProfissionalLogado().getIdEmpresa(), local);
        }
