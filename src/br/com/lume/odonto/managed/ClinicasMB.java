...
public class ClinicasMB extends LumeManagedBean<Empresa> {
    ...
    public void actionPersistNovoConsultor() {
        ...
        try {
            ...
            LogEmpresaSingleton.getInstance().criaLog(new Date(), UtilsFrontEnd.getUsuarioLogado(), getEntity(),
                    "Usuário criado no painel do parceiro. Email do usuario: " + this.usuario.getUsuStrEml());
    ...
    public void actionInativar(Empresa empresa) {
        try {
            ...
            String assinatura = empresa.getAssinaturaIuguBanco();
            EmpresaSingleton.getInstance().getBo().persist(empresa);
            Iugu.getInstance().inativaAssinatura(assinatura);
    ...
    public void actionAtivar(Empresa empresa) {
        try {
            ...
            String assinatura = empresa.getAssinaturaIuguBanco();
            EmpresaSingleton.getInstance().getBo().persist(empresa);
            Iugu.getInstance().ativaAssinatura(assinatura);
    ...
    public void actionSalvarEditarUsuario() {
        try {
            ...
            LogEmpresaSingleton.getInstance().criaLog(new Date(), UtilsFrontEnd.getUsuarioLogado(), getEntity(),
                    "Usuário alterado no painel do parceiro. Id do usuario alterado: " + this.usuario.getUsuIntCod());
