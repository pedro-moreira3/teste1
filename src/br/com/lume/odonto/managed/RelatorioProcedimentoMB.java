    ...
    public void popularLista() {
        try {
            ...
            if (validarIntervaloDatas()) {
                ...
                this.listaProcedimentos = PlanoTratamentoProcedimentoSingleton.getInstance().getBo().listByDataAndProfissionalAndPaciente(Utils.formataComecoDia(this.dataInicio),
                        Utils.formataFimDia(this.dataFim), Utils.formataComecoDia(this.dataFinalizacaoInicio), Utils.formataFimDia(this.dataFinalizacaoFim), this.filtroPorPaciente,
                        this.filtroPorProfissional, this.filtroPorPlanoTratamento, this.getConvenio(filtroPorConvenio), this.filtroPorProcedimento,
                        UtilsFrontEnd.getProfissionalLogado().getIdEmpresa(), this.filtroPorEspecialidade);
