package br.com.lume.odonto.iugu.responses;
...
public class SubscriptionResponse {
    ...
    public String toString() {
        return "SubscriptionResponse{" + "id='" + id + '\'' + ", suspended=" + suspended + ", planIdentifier='" + planIdentifier + '\'' + ", priceCents=" + priceCents + ", currency='" + currency + '\'' + ", expiresAt=" + expiresAt + ", customerName='" + customerName + '\'' + ", customerEmail='" + customerEmail + '\'' + ", cycledAt=" + cycledAt + ", creditsMin=" + creditsMin + ", customerId='" + customerId + '\'' + ", planName='" + planName + '\'' + ", customerRef='" + customerRef + '\'' + ", planRef='" + planRef + '\'' + ", active=" + active + ", inTrial=" + inTrial + ", credits=" + credits + ", creditsBased=" + creditsBased + ", subitems=" + subitems + ", logs=" + logs + ", customVariables=" + customVariables + '}';
    }
