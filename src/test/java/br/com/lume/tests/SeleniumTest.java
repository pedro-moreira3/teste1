...
public class SeleniumTest {
	...
	private static final String SYS_PARAM_HEADLESS = "headless";						// Parâmetro para tivar e desativar uso de UI pelo teste
	private static final String SYS_PARAM_TEST_URL = "urlteste";						// Parâmetro para definir url de teste
	private static final String SYS_PARAM_FINALIZAR = "finalizar";						// Parâmetro para definir se navegar ira ser finalizado no fim do teste
	private static final String SYS_PARAM_CHROME_DRIVER = "webdriver.chrome.driver";	// Parâmetro para definir 
	...
	public void setUp() {
		...
		if (modoHeadless)
			options.addArguments("--headless");				// Desabilita interface gráfica 
		options.addArguments("--disable-infobars");			// Desabilita barras de alerta
		options.addArguments("--disable-extensions"); 		// Desabilita extensÃµes
		...
		options.addArguments("--no-sandbox"); 				// Necessário para executar chrome como usuário root em linux
