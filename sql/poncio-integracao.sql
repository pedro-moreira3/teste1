...
alter table DETAIL_PACOTE_CONFIRMACAO_AUTO ALTER COLUMN SMS_ATIVO set default 'S'

alter table DETAIL_PACOTE_CONFIRMACAO_AUTO ALTER COLUMN WHATS_ATIVO set default 'S'
