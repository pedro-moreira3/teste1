...
alter table DETAIL_PACOTE_CONFIRMACAO_AUTO add COLUMN SMS_ATIVO VARCHAR(10) default 'S';

alter table DETAIL_PACOTE_CONFIRMACAO_AUTO add COLUMN WHATS_ATIVO VARCHAR(10) default 'S';
