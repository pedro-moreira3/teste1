...
SELECT
	OBJ_INT_COD, 'Agenda Por Profissional',
...
SELECT
	(
		...
		WHERE OBJ_STR_DES = 'Agenda Por Profissional'
		LIMIT 1
	),
	OP.ID_PROFISSIONAL
...
ALTER TABLE NEGOCIACAO_FATURA ADD COLUMN RESULTADO_DESCONTO DECIMAL(15,2);
ALTER TABLE NEGOCIACAO_ORCAMENTO ADD COLUMN RESULTADO_DESCONTO DECIMAL(15,2);

CREATE TABLE NEGOCIACAO_ORCAMENTO (
	ID SERIAL PRIMARY KEY,
	QUANTIDADE_PARCELAS NUMERIC(3),
	TIPO_DESCONTO VARCHAR(2),
	VALOR_DESCONTO DECIMAL(15,2),
	RESULTADO_DESCONTO DECIMAL(15,2),
	VALOR_PRIMEIRA_PARCELA DECIMAL(15,2),
	VALOR_PARCELA DECIMAL(15,2),
	VALOR_TOTAL DECIMAL(15,2),
	VALOR_FINAL DECIMAL(15,2),
	NEGOCIADO_EM TIMESTAMP(10),
	NEGOCIADO_POR BIGINT REFERENCES PROFISSIONAL(ID),
	OBSERVAÇÃO TEXT,
...
ALTER TABLE LANCAMENTO ADD COLUMN NEGOCIACAO_FATURA_ID BIGINT REFERENCES NEGOCIACAO_FATURA(ID);
