(function ($) {
  ...
  $.fn.wPaint.menus.main = {
    img: "/intelidente/javax.faces.resource/plugins/main/img/icons-menu-main.png.jsf?ln=wPaint",
    items: {
      undo: {
        icon: 'generic',
        title: 'Undo',
  ...
  $.extend($.fn.wPaint.cursors, {
    'default': {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-crosshair.png.jsf?ln=wPaint', left: 7, top: 7},
    dropper:   {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-dropper.png.jsf?ln=wPaint', left: 0, top: 12},
    pencil:    {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-pencil.png.jsf?ln=wPaint', left: 0, top: 11.99},
    bucket:    {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-bucket.png.jsf?ln=wPaint', left: 0, top: 10},
    eraser1:   {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-eraser1.png.jsf?ln=wPaint', left: 1, top: 1},
    eraser2:   {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-eraser2.png.jsf?ln=wPaint', left: 2, top: 2},
    eraser3:   {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-eraser3.png.jsf?ln=wPaint', left: 2, top: 2},
    eraser4:   {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-eraser4.png.jsf?ln=wPaint', left: 3, top: 3},
    eraser5:   {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-eraser5.png.jsf?ln=wPaint', left: 3, top: 3},
    eraser6:   {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-eraser6.png.jsf?ln=wPaint', left: 4, top: 4},
    eraser7:   {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-eraser7.png.jsf?ln=wPaint', left: 4, top: 4},
    eraser8:   {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-eraser8.png.jsf?ln=wPaint', left: 5, top: 5 },
    eraser9:   {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-eraser9.png.jsf?ln=wPaint', left: 5, top: 5},
    eraser10:  {path: '/intelidente/javax.faces.resource/plugins/main/img/cursor-eraser10.png.jsf?ln=wPaint', left: 6, top: 6}
  });
